...
$<PROPNAME> = Get-AnsibleParam -obj $params -name <PROPNAME> -failifempty $<MANDATORY> -resultobj $result -default <DEFAULTVALUE>
'@            
        }
        Else
        {
            $PropContent = @'
#ATTRIBUTE:<PROPNAME>;MANDATORY:<MANDATORY>;DEFAULTVALUE:<DEFAULTVALUE>;DESCRIPTION:<DESCRIPTION>;CHOICES:<CHOICES>
$<PROPNAME> = Get-AnsibleParam -obj $params -name <PROPNAME> -failifempty $<MANDATORY> -resultobj $result
'@
        }
...
$<PROPNAME>_username = Get-AnsibleParam -obj $params -name <PROPNAME>_username -failifempty $<MANDATORY> -resultobj $result
#ATTRIBUTE:<PROPNAME>_password;MANDATORY:<MANDATORY>;DEFAULTVALUE:<DEFAULTVALUE>;DESCRIPTION:<DESCRIPTION>;CHOICES:<CHOICES>
$<PROPNAME>_password = Get-AnsibleParam -obj $params -name <PROPNAME>_password -failifempty $<MANDATORY> -resultobj $result
'@
