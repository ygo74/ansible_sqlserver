...
#ATTRIBUTE:SecureConnectionLevel;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SecureConnectionLevel = Get-AnsibleParam -obj $params -name SecureConnectionLevel -failifempty $True -resultobj $result
...
$DscResourceName = "xSQLServerRSSecureConnectionLevel"
