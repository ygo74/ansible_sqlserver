...
#ATTRIBUTE:Database;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Database = Get-AnsibleParam -obj $params -name Database -failifempty $True -resultobj $result
...
#ATTRIBUTE:Permissions;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Permissions = Get-AnsibleParam -obj $params -name Permissions -failifempty $True -resultobj $result
#ATTRIBUTE:PermissionState;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Deny,Grant,GrantWithGrant
$PermissionState = Get-AnsibleParam -obj $params -name PermissionState -failifempty $True -resultobj $result
...
If ($PermissionState)
{
    If (('Deny','Grant','GrantWithGrant') -contains $PermissionState ) {
    }
    Else
    {
        Fail-Json $result "Option PermissionState has invalid value $PermissionState. Valid values are 'Deny','Grant','GrantWithGrant'"
    }
}
...
$DscResourceName = "xSQLServerDatabasePermission"
