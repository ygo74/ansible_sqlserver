...
$LoginCredential_username = Get-AnsibleParam -obj $params -name LoginCredential_username -failifempty $False -resultobj $result
#ATTRIBUTE:LoginCredential_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LoginCredential_password = Get-AnsibleParam -obj $params -name LoginCredential_password -failifempty $False -resultobj $result
#ATTRIBUTE:LoginMustChangePassword;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LoginMustChangePassword = Get-AnsibleParam -obj $params -name LoginMustChangePassword -failifempty $False -resultobj $result
#ATTRIBUTE:LoginPasswordExpirationEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LoginPasswordExpirationEnabled = Get-AnsibleParam -obj $params -name LoginPasswordExpirationEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:LoginPasswordPolicyEnforced;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LoginPasswordPolicyEnforced = Get-AnsibleParam -obj $params -name LoginPasswordPolicyEnforced -failifempty $False -resultobj $result
#ATTRIBUTE:LoginType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:AsymmetricKey,Certificate,ExternalGroup,ExternalUser,SqlLogin,WindowsGroup,WindowsUser
$LoginType = Get-AnsibleParam -obj $params -name LoginType -failifempty $False -resultobj $result
...
If ($LoginType)
{
    If (('AsymmetricKey','Certificate','ExternalGroup','ExternalUser','SqlLogin','WindowsGroup','WindowsUser') -contains $LoginType ) {
    }
    Else
    {
        Fail-Json $result "Option LoginType has invalid value $LoginType. Valid values are 'AsymmetricKey','Certificate','ExternalGroup','ExternalUser','SqlLogin','WindowsGroup','WindowsUser'"
    }
}
...
if ($LoginCredential_username)
{
$LoginCredential_securepassword = $LoginCredential_password | ConvertTo-SecureString -asPlainText -Force
$LoginCredential = New-Object System.Management.Automation.PSCredential($LoginCredential_username,$LoginCredential_securepassword)
}
