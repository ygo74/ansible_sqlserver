...
$Principal = Get-AnsibleParam -obj $params -name Principal -failifempty $True -resultobj $result
...
#ATTRIBUTE:NodeName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NodeName = Get-AnsibleParam -obj $params -name NodeName -failifempty $False -resultobj $result
#ATTRIBUTE:Permission;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:AlterAnyAvailabilityGroup,AlterAnyEndPoint,ConnectSql,ViewServerState
$Permission = Get-AnsibleParam -obj $params -name Permission -failifempty $False -resultobj $result
...
If ($Permission)
{
    If (('AlterAnyAvailabilityGroup','AlterAnyEndPoint','ConnectSql','ViewServerState') -contains $Permission ) {
    }
    Else
    {
        Fail-Json $result "Option Permission has invalid value $Permission. Valid values are 'AlterAnyAvailabilityGroup','AlterAnyEndPoint','ConnectSql','ViewServerState'"
    }
}
...
$DscResourceName = "xSQLServerPermission"
