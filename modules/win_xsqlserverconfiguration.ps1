...
#ATTRIBUTE:OptionName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OptionName = Get-AnsibleParam -obj $params -name OptionName -failifempty $True -resultobj $result
#ATTRIBUTE:OptionValue;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OptionValue = Get-AnsibleParam -obj $params -name OptionValue -failifempty $True -resultobj $result
...
$DscResourceName = "xSQLServerConfiguration"
