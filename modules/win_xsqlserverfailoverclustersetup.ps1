...
#ATTRIBUTE:Action;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Complete,Prepare
$Action = Get-AnsibleParam -obj $params -name Action -failifempty $True -resultobj $result
#ATTRIBUTE:FailoverClusterNetworkName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FailoverClusterNetworkName = Get-AnsibleParam -obj $params -name FailoverClusterNetworkName -failifempty $True -resultobj $result
#ATTRIBUTE:Features;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Features = Get-AnsibleParam -obj $params -name Features -failifempty $True -resultobj $result
...
$SQLSvcAccount_username = Get-AnsibleParam -obj $params -name SQLSvcAccount_username -failifempty $True -resultobj $result
#ATTRIBUTE:SQLSvcAccount_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SQLSvcAccount_password = Get-AnsibleParam -obj $params -name SQLSvcAccount_password -failifempty $True -resultobj $result
...
#ATTRIBUTE:FailoverClusterGroup;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FailoverClusterGroup = Get-AnsibleParam -obj $params -name FailoverClusterGroup -failifempty $False -resultobj $result
...
#ATTRIBUTE:ISFileSystemFolder;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ISFileSystemFolder = Get-AnsibleParam -obj $params -name ISFileSystemFolder -failifempty $False -resultobj $result
...
$PID = Get-AnsibleParam -obj $params -name PID -failifempty $False -resultobj $result
...
$SourceFolder = Get-AnsibleParam -obj $params -name SourceFolder -failifempty $False -resultobj $result
...
If ($Action)
{
    If (('Complete','Prepare') -contains $Action ) {
    }
    Else
    {
        Fail-Json $result "Option Action has invalid value $Action. Valid values are 'Complete','Prepare'"
    }
}
