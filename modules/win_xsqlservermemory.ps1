...
$DynamicAlloc = Get-AnsibleParam -obj $params -name DynamicAlloc -failifempty $False -resultobj $result
...
#ATTRIBUTE:MaxMemory;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaxMemory = Get-AnsibleParam -obj $params -name MaxMemory -failifempty $False -resultobj $result
#ATTRIBUTE:MinMemory;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MinMemory = Get-AnsibleParam -obj $params -name MinMemory -failifempty $False -resultobj $result
...
$DscResourceName = "xSQLServerMemory"
