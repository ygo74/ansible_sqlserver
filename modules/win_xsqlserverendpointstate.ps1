...
#ATTRIBUTE:State;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Disabled,Started,Stopped
...
If ($State)
{
    If (('Disabled','Started','Stopped') -contains $State ) {
    }
    Else
    {
        Fail-Json $result "Option State has invalid value $State. Valid values are 'Disabled','Started','Stopped'"
    }
}
...
$DscResourceName = "xSQLServerEndpointState"
