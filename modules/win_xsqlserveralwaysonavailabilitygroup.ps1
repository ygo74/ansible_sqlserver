...
$SQLInstanceName = Get-AnsibleParam -obj $params -name SQLInstanceName -failifempty $True -resultobj $result
#ATTRIBUTE:SQLServer;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SQLServer = Get-AnsibleParam -obj $params -name SQLServer -failifempty $True -resultobj $result
#ATTRIBUTE:AutomatedBackupPreference;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:None,Primary,Secondary,SecondaryOnly
$AutomatedBackupPreference = Get-AnsibleParam -obj $params -name AutomatedBackupPreference -failifempty $False -resultobj $result
#ATTRIBUTE:AvailabilityMode;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:AsynchronousCommit,SynchronousCommit
$AvailabilityMode = Get-AnsibleParam -obj $params -name AvailabilityMode -failifempty $False -resultobj $result
#ATTRIBUTE:BackupPriority;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BackupPriority = Get-AnsibleParam -obj $params -name BackupPriority -failifempty $False -resultobj $result
#ATTRIBUTE:BasicAvailabilityGroup;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BasicAvailabilityGroup = Get-AnsibleParam -obj $params -name BasicAvailabilityGroup -failifempty $False -resultobj $result
#ATTRIBUTE:ConnectionModeInPrimaryRole;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:AllowAllConnections,AllowReadWriteConnections
$ConnectionModeInPrimaryRole = Get-AnsibleParam -obj $params -name ConnectionModeInPrimaryRole -failifempty $False -resultobj $result
#ATTRIBUTE:ConnectionModeInSecondaryRole;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:AllowAllConnections,AllowNoConnections,AllowReadIntentConnectionsOnly
$ConnectionModeInSecondaryRole = Get-AnsibleParam -obj $params -name ConnectionModeInSecondaryRole -failifempty $False -resultobj $result
#ATTRIBUTE:EndpointHostName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EndpointHostName = Get-AnsibleParam -obj $params -name EndpointHostName -failifempty $False -resultobj $result
...
#ATTRIBUTE:FailoverMode;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Automatic,Manual
$FailoverMode = Get-AnsibleParam -obj $params -name FailoverMode -failifempty $False -resultobj $result
#ATTRIBUTE:FailureConditionLevel;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:OnAnyQualifiedFailureCondition,OnCriticalServerErrors,OnModerateServerErrors,OnServerDown,OnServerUnresponsive
$FailureConditionLevel = Get-AnsibleParam -obj $params -name FailureConditionLevel -failifempty $False -resultobj $result
#ATTRIBUTE:HealthCheckTimeout;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$HealthCheckTimeout = Get-AnsibleParam -obj $params -name HealthCheckTimeout -failifempty $False -resultobj $result
...
{
    If (('None','Primary','Secondary','SecondaryOnly') -contains $AutomatedBackupPreference ) {
    }
    Else
    {
        Fail-Json $result "Option AutomatedBackupPreference has invalid value $AutomatedBackupPreference. Valid values are 'None','Primary','Secondary','SecondaryOnly'"
    }
}
...
If ($AvailabilityMode)
{
    If (('AsynchronousCommit','SynchronousCommit') -contains $AvailabilityMode ) {
    }
    Else
    {
        Fail-Json $result "Option AvailabilityMode has invalid value $AvailabilityMode. Valid values are 'AsynchronousCommit','SynchronousCommit'"
    }
}
...
{
    If (('AllowAllConnections','AllowReadWriteConnections') -contains $ConnectionModeInPrimaryRole ) {
    }
    Else
    {
        Fail-Json $result "Option ConnectionModeInPrimaryRole has invalid value $ConnectionModeInPrimaryRole. Valid values are 'AllowAllConnections','AllowReadWriteConnections'"
    }
}
...
{
    If (('AllowAllConnections','AllowNoConnections','AllowReadIntentConnectionsOnly') -contains $ConnectionModeInSecondaryRole ) {
    }
    Else
    {
        Fail-Json $result "Option ConnectionModeInSecondaryRole has invalid value $ConnectionModeInSecondaryRole. Valid values are 'AllowAllConnections','AllowNoConnections','AllowReadIntentConnectionsOnly'"
    }
}
...
If ($FailoverMode)
{
    If (('Automatic','Manual') -contains $FailoverMode ) {
    }
    Else
    {
        Fail-Json $result "Option FailoverMode has invalid value $FailoverMode. Valid values are 'Automatic','Manual'"
    }
}
...
{
    If (('OnAnyQualifiedFailureCondition','OnCriticalServerErrors','OnModerateServerErrors','OnServerDown','OnServerUnresponsive') -contains $FailureConditionLevel ) {
    }
    Else
    {
        Fail-Json $result "Option FailureConditionLevel has invalid value $FailureConditionLevel. Valid values are 'OnAnyQualifiedFailureCondition','OnCriticalServerErrors','OnModerateServerErrors','OnServerDown','OnServerUnresponsive'"
    }
}
