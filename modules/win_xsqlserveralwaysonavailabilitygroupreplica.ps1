...
#ATTRIBUTE:AvailabilityGroupName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AvailabilityGroupName = Get-AnsibleParam -obj $params -name AvailabilityGroupName -failifempty $True -resultobj $result
...
#ATTRIBUTE:PrimaryReplicaSQLInstanceName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PrimaryReplicaSQLInstanceName = Get-AnsibleParam -obj $params -name PrimaryReplicaSQLInstanceName -failifempty $False -resultobj $result
#ATTRIBUTE:PrimaryReplicaSQLServer;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PrimaryReplicaSQLServer = Get-AnsibleParam -obj $params -name PrimaryReplicaSQLServer -failifempty $False -resultobj $result
...
#ATTRIBUTE:ReadOnlyRoutingConnectionUrl;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ReadOnlyRoutingConnectionUrl = Get-AnsibleParam -obj $params -name ReadOnlyRoutingConnectionUrl -failifempty $False -resultobj $result
#ATTRIBUTE:ReadOnlyRoutingList;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ReadOnlyRoutingList = Get-AnsibleParam -obj $params -name ReadOnlyRoutingList -failifempty $False -resultobj $result
