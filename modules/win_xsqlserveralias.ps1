...
$ServerName = Get-AnsibleParam -obj $params -name ServerName -failifempty $True -resultobj $result
...
$Protocol = Get-AnsibleParam -obj $params -name Protocol -failifempty $False -resultobj $result
...
#ATTRIBUTE:UseDynamicTcpPort;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UseDynamicTcpPort = Get-AnsibleParam -obj $params -name UseDynamicTcpPort -failifempty $False -resultobj $result
...
$DscResourceName = "xSQLServerAlias"
