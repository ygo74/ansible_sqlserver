...
#ATTRIBUTE:AdminLinkCredentials_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AdminLinkCredentials_username = Get-AnsibleParam -obj $params -name AdminLinkCredentials_username -failifempty $True -resultobj $result
#ATTRIBUTE:AdminLinkCredentials_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AdminLinkCredentials_password = Get-AnsibleParam -obj $params -name AdminLinkCredentials_password -failifempty $True -resultobj $result
#ATTRIBUTE:DistributorMode;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Local,Remote
$DistributorMode = Get-AnsibleParam -obj $params -name DistributorMode -failifempty $True -resultobj $result
...
#ATTRIBUTE:WorkingDirectory;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WorkingDirectory = Get-AnsibleParam -obj $params -name WorkingDirectory -failifempty $True -resultobj $result
#ATTRIBUTE:DistributionDBName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DistributionDBName = Get-AnsibleParam -obj $params -name DistributionDBName -failifempty $False -resultobj $result
...
#ATTRIBUTE:RemoteDistributor;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RemoteDistributor = Get-AnsibleParam -obj $params -name RemoteDistributor -failifempty $False -resultobj $result
#ATTRIBUTE:UninstallWithForce;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UninstallWithForce = Get-AnsibleParam -obj $params -name UninstallWithForce -failifempty $False -resultobj $result
#ATTRIBUTE:UseTrustedConnection;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UseTrustedConnection = Get-AnsibleParam -obj $params -name UseTrustedConnection -failifempty $False -resultobj $result
...
If ($DistributorMode)
{
    If (('Local','Remote') -contains $DistributorMode ) {
    }
    Else
    {
        Fail-Json $result "Option DistributorMode has invalid value $DistributorMode. Valid values are 'Local','Remote'"
    }
}
...
if ($AdminLinkCredentials_username)
{
$AdminLinkCredentials_securepassword = $AdminLinkCredentials_password | ConvertTo-SecureString -asPlainText -Force
$AdminLinkCredentials = New-Object System.Management.Automation.PSCredential($AdminLinkCredentials_username,$AdminLinkCredentials_securepassword)
}
...
$DscResourceName = "xSQLServerReplication"
