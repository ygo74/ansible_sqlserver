...
$RetryCount = Get-AnsibleParam -obj $params -name RetryCount -failifempty $False -resultobj $result
#ATTRIBUTE:RetryIntervalSec;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RetryIntervalSec = Get-AnsibleParam -obj $params -name RetryIntervalSec -failifempty $False -resultobj $result
...
$DscResourceName = "xWaitForAvailabilityGroup"
