...
#ATTRIBUTE:GetFilePath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$GetFilePath = Get-AnsibleParam -obj $params -name GetFilePath -failifempty $True -resultobj $result
#ATTRIBUTE:ServerInstance;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServerInstance = Get-AnsibleParam -obj $params -name ServerInstance -failifempty $True -resultobj $result
#ATTRIBUTE:SetFilePath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SetFilePath = Get-AnsibleParam -obj $params -name SetFilePath -failifempty $True -resultobj $result
#ATTRIBUTE:TestFilePath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TestFilePath = Get-AnsibleParam -obj $params -name TestFilePath -failifempty $True -resultobj $result
...
#ATTRIBUTE:Variable;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Variable = Get-AnsibleParam -obj $params -name Variable -failifempty $False -resultobj $result
...
$DscResourceName = "xSQLServerScript"
