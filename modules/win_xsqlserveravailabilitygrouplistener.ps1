...
#ATTRIBUTE:AvailabilityGroup;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AvailabilityGroup = Get-AnsibleParam -obj $params -name AvailabilityGroup -failifempty $True -resultobj $result
...
#ATTRIBUTE:NodeName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NodeName = Get-AnsibleParam -obj $params -name NodeName -failifempty $True -resultobj $result
#ATTRIBUTE:DHCP;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DHCP = Get-AnsibleParam -obj $params -name DHCP -failifempty $False -resultobj $result
...
$IpAddress = Get-AnsibleParam -obj $params -name IpAddress -failifempty $False -resultobj $result
...
$DscResourceName = "xSQLServerAvailabilityGroupListener"
