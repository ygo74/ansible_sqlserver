...
#ATTRIBUTE:Role;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Role = Get-AnsibleParam -obj $params -name Role -failifempty $True -resultobj $result
...
$DscResourceName = "xSQLServerDatabaseRole"
