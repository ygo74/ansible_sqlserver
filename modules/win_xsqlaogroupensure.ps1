...
$AutoBackupPreference = Get-AnsibleParam -obj $params -name AutoBackupPreference -failifempty $False -resultobj $result
#ATTRIBUTE:AvailabilityGroupNameIP;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AvailabilityGroupNameIP = Get-AnsibleParam -obj $params -name AvailabilityGroupNameIP -failifempty $False -resultobj $result
#ATTRIBUTE:AvailabilityGroupNameListener;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AvailabilityGroupNameListener = Get-AnsibleParam -obj $params -name AvailabilityGroupNameListener -failifempty $False -resultobj $result
#ATTRIBUTE:AvailabilityGroupPort;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AvailabilityGroupPort = Get-AnsibleParam -obj $params -name AvailabilityGroupPort -failifempty $False -resultobj $result
#ATTRIBUTE:AvailabilityGroupSubMask;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AvailabilityGroupSubMask = Get-AnsibleParam -obj $params -name AvailabilityGroupSubMask -failifempty $False -resultobj $result
...
$EndPointPort = Get-AnsibleParam -obj $params -name EndPointPort -failifempty $False -resultobj $result
...
#ATTRIBUTE:ReadableSecondary;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:None,ReadIntent,ReadOnly
$ReadableSecondary = Get-AnsibleParam -obj $params -name ReadableSecondary -failifempty $False -resultobj $result
#ATTRIBUTE:SQLInstanceName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SQLInstanceName = Get-AnsibleParam -obj $params -name SQLInstanceName -failifempty $False -resultobj $result
#ATTRIBUTE:SQLServer;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SQLServer = Get-AnsibleParam -obj $params -name SQLServer -failifempty $False -resultobj $result
...
If ($ReadableSecondary)
{
    If (('None','ReadIntent','ReadOnly') -contains $ReadableSecondary ) {
    }
    Else
    {
        Fail-Json $result "Option ReadableSecondary has invalid value $ReadableSecondary. Valid values are 'None','ReadIntent','ReadOnly'"
    }
}
