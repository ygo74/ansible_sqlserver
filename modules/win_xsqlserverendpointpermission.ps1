...
#ATTRIBUTE:Permission;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:CONNECT
...
If ($Permission)
{
    If (('CONNECT') -contains $Permission ) {
    }
    Else
    {
        Fail-Json $result "Option Permission has invalid value $Permission. Valid values are 'CONNECT'"
    }
}
...
$DscResourceName = "xSQLServerEndpointPermission"
