...
#ATTRIBUTE:ServerRoleName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServerRoleName = Get-AnsibleParam -obj $params -name ServerRoleName -failifempty $True -resultobj $result
...
$DscResourceName = "xSQLServerRole"
