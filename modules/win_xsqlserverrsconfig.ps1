...
#ATTRIBUTE:RSSQLInstanceName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RSSQLInstanceName = Get-AnsibleParam -obj $params -name RSSQLInstanceName -failifempty $True -resultobj $result
#ATTRIBUTE:RSSQLServer;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RSSQLServer = Get-AnsibleParam -obj $params -name RSSQLServer -failifempty $True -resultobj $result
#ATTRIBUTE:SQLAdminCredential_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SQLAdminCredential_username = Get-AnsibleParam -obj $params -name SQLAdminCredential_username -failifempty $True -resultobj $result
#ATTRIBUTE:SQLAdminCredential_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SQLAdminCredential_password = Get-AnsibleParam -obj $params -name SQLAdminCredential_password -failifempty $True -resultobj $result
...
$SQLAdminCredential = New-Object System.Management.Automation.PSCredential($SQLAdminCredential_username,$SQLAdminCredential_securepassword)
}
...
$DscResourceName = "xSQLServerRSConfig"
